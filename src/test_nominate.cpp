...
int main() {
    ...
    std::cout << "=== TEST ENTORNO COMPLETO ===" << std::endl;
    ...
    // Test distribución normal (implementación propia)
    ...
    // Test funcionalidades matemáticas básicas
    std::cout << "\n5. Test Funciones Matemáticas:" << std::endl;
    std::cout << "   exp(1.0) = " << std::exp(1.0) << std::endl;
    std::cout << "   sqrt(2.0) = " << std::sqrt(2.0) << std::endl;
    std::cout << "   erf(1.0) = " << std::erf(1.0) << std::endl;
